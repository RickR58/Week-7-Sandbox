...
console.log(`-------------------------- 
     ...
     *
     * ↓ YOUR CODE HERE ↓ */
    const whatsForLunch = (myMeal, myDrink) => `${meal} ${drink}`;
    
    let myName = "Rick";
    let friendsName = 'Allison';
    console.log(myName, friendsName);
    
    //Question: Name a reason why you would use const instead of let.
    //Answer: Because const locks the value.
    ...
    */
    const me = "Rick";
    const friend = "Allison";
    const myMeal = "burgers";
    const myDrink = "Dr. Pepper";
    const introductionWithTemplate = `For lunch, ${me} and ${friend} are having ${myMeal} and ${myDrink}.`;
    ...
    //Answer:
    /*
    const lunchWithStringConcatenation =
      "Our names are " +
      me +
      " and " +
      friend +
      ...
      myDrink +
      " for lunch.";
    console.log(lunchWithStringConcatenation);
    */
    //Question 2a: Oh no`)
     ...
     *
     * ↓ YOUR CODE HERE ↓ */
    //let myDrink = "Dr. Pepper";
    
    //Question: Read the error message - in your own words - what does it mean?
    //Answer: The error has been declared and can't be changed because of the const.
    ...
    const lunchTime=(foodChoice, drinkChoice) => `My friend ${friend} & ${me} are
    ...
    const drinkChoice = "Water";
    console.log(`For lunch, ${me} and ${friend} are having ${foodChoice} and ${drinkChoice}.`);
     ...
     *
     * Step 1: Create a ES6 fat arrow function called 'foodForTodayAndTomorrow' that takes 3 parameters: foodForTodayAndTomorrow, tomorrowsDrinkChoice, and callbackFunction.
    ...
    console.log(
      foodForTodayAndTomorrow('Pizza', 'Soda', lunchTime('Crepes', 'Bordeaux'))
    )
